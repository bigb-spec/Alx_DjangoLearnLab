...
SECRET_KEY = 'django-insecure-43el5i=yuu$0veimz&$43fc-lf21agz8g0x^yvh4q@$83j-6ef'
...
# Ensure security settings are only active in production
if not DEBUG:
    # Redirect all HTTP traffic to HTTPS
    SECURE_SSL_REDIRECT = True  

    # Tell Django it’s behind a proxy (Nginx/Apache) that handles SSL
    ...
    # Prevent clickjacking (site in iframes)
    # Use "SAMEORIGIN" if you need admin embedded in iframes
    X_FRAME_OPTIONS = "DENY"  
